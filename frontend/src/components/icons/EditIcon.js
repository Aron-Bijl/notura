...
const EditIcon = (props) => {
  ...
  return (
    ...
    <g id="Compose">
      <polyline stroke-width={stroke} fill={fill} points="43,21 43,47 5,47 5,7 26,7 	"/>
      <polygon stroke-width={stroke} fill={fill} points="27.3,32.7 19.9,38.4 21.1,29.2 32,10.2 38.2,13.8 	"/>
